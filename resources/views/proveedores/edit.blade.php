...
<div class="max-w-4xl mx-auto" x-data="proveedorEditForm()">
    ...
    <div class="form-section bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Editar Proveedor</h1>
                    <p class="text-sm text-gray-600 mt-1">Actualiza la información del proveedor existente</p>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:items-end gap-2">
                ...
                <span x-show="hasChanges" x-cloak class="changes-badge inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 border border-yellow-200">
    ...
    <form action="{{ route('proveedores.update', $proveedor->id) }}" method="POST" @submit.prevent="submitForm">
        @csrf
        @method('PUT')
        ...
        <div class="form-section bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
            ...
            <div class="border-b border-gray-200">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div class="mt-1 flex items-center" x-show="nombreMessage" x-transition x-cloak>
            ...
            <div class="border-b border-gray-200">
                ...
                <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="mt-1 flex items-center" x-show="emailMessage" x-transition x-cloak>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center" x-show="phoneMessage" x-transition x-cloak>
        ...
        <!-- Alerta de cambios -->
        <div x-show="hasChanges" x-transition x-cloak class="form-section bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-amber-700 mt-1">Los cambios se guardarán al hacer clic en "Actualizar Proveedor"</p>
                </div>
            </div>
        </div>
        ...
        <div class="form-section flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <div class="flex items-center gap-3 w-full sm:w-auto">
                <a href="{{ route('proveedores.index') }}" 
                   @click.prevent="checkBeforeLeaving"
...
function proveedorEditForm() {
    return {
        ...
        validateNombre() {
            ...
            if (nombre.length === 0) {
                this.nombreValid = false; this.nombreMessage = 'El nombre es obligatorio';
        ...
        validatePhone() {
            ...
            if (phone.length >= 7) {
                this.phoneValid = true; this.phoneMessage = 'Teléfono válido';
            } else {
                this.phoneValid = false; this.phoneMessage = '';
            }
        },
        ...
        async submitForm(event) {
            ...
            let changesHtml = '<div class="text-left space-y-2 text-sm"><p class="font-semibold mb-2">Cambios realizados:</p>';
        ...
        showNotification(message, type = 'info') {
            ...
            else if (type === 'info') { config.background = '#f0f9ff'; config.color = '#1e40af'; }
        ...
        init() {
            this.validateNombre();
            if (this.form.contacto) this.validateEmail();
            if (this.form.telefono) this.validatePhone();
            this.detectChanges();
