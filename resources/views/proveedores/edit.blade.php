...
<div class="max-w-5xl mx-auto px-4 py-6 space-y-6">
    ...
    <nav class="fade-in flex items-center space-x-2 text-sm text-gray-500">
        ...
        <span class="font-medium text-gray-900">Editar Proveedor</span>
    </nav>
    ...
    <div class="fade-in bg-gradient-to-r from-[#218786] to-[#1a6d6c] rounded-2xl shadow-lg p-6">
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white mb-1">Editar Proveedor</h1>
                    <p class="text-white/80">Actualiza la información del proveedor</p>
                </div>
            </div>
            ...
            <div class="bg-white/20 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/30">
                <div class="flex items-center gap-3 text-white text-sm">
                    <div>
                        <p class="opacity-80 text-xs mb-1">Registrado</p>
                        <p class="font-bold">{{ $proveedor->created_at->format('d/m/Y') }}</p>
                    </div>
                    <div class="w-px h-10 bg-white/30"></div>
                    <div>
                        <p class="opacity-80 text-xs mb-1">Última actualización</p>
                        <p class="font-bold">{{ $proveedor->updated_at->diffForHumans() }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="p-6">
                    <div class="group">
                        ...
                        <textarea 
                            ...
                            placeholder="Av. Principal 123, Distrito, Ciudad">{{ old('direccion', $proveedor->direccion) }}</textarea>
