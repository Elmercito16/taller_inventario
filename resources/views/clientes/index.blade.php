...
<div class="space-y-6" x-data="clientesManager()">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- Total Clientes -->
        <div class="stat-card bg-gradient-to-br from-[#218786] to-[#1a6d6c] rounded-xl shadow-lg p-6 text-white hover:shadow-xl transition-shadow">
            ...
            <p class="text-sm font-medium text-white/80">Total Clientes</p>
            <p class="text-4xl font-bold mt-1">{{ $clientes->count() }}</p>
        </div>
